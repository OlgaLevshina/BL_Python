...
class Road():
    ...
    def mass_asphalt(self, ma_one_square, thickness):
        print("Масса асфальта, необходимого для покрытия всего дорожного полотна составляет:")
        return self._length*self._width*ma_one_square*thickness

road1 = Road(200, 6)
print(road1.mass_asphalt(25, 5))
